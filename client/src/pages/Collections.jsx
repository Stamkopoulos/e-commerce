          ...
          <div className="w-full max-w-6xl mx-auto px-4 py-8">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {collections.map((c) => (
                ...
                >
                  {/* transparent card so no color fill - rely on background image */}
                  <div className="absolute inset-0" />

                  <div className="relative z-10 text-center px-6">
                    <h2 className="text-2xl sm:text-3xl font-semibold text-black-200 drop-shadow-md">
                      {c.title}
                    </h2>
                  ...
                  {/* subtle frame so card edges are visible on varied backgrounds */}
