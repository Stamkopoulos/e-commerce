    ...
    <main>
      ...
      {showUp && (
        <button
          ...
          className="fixed right-4 sm:right-8 bottom-4 sm:bottom-8 text-white bg-black py-2 px-3 sm:px-4 rounded-full text-sm sm:text-base hover:bg-gray-800 transition"
        >
          &#8593;
        </button>
      )}
