...
export default function CartDrawer() {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <aside
        className={`fixed top-0 right-0 h-full w-[27%] min-w-[340px] bg-white z-50 rounded-xl 3xl
            ...
            cart.map((item, index) => (
              ...
              >
                ...
                <div className="flex-1 text-center min-w-0">
                  <p className="font-medium text-md leading-snug tracking-tight break-words text-wrap sm:text-balance md:text-balance md: leading-tight">
                    {item.name}
                  </p>
